...
async function findOne(req, res) {
    try {
        ...
        const flight = await em.findOne(Flight, { id }, { populate: ['destino'] });
        if (!flight) {
...
async function findByDestino(req, res) {
    try {
        const em = orm.em.fork();
...
async function buscarVuelos(req, res) {
    try {
        ...
        const flights = await em.find(Flight, queryConditions, { populate: ['destino'] });
